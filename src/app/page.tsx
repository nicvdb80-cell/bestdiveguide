...
const CATS = [
  {t:"Top 99 Asia",c:"#E8723A",h:"/top100",d:"The definitive ranking of Asia’s best dive experiences. Resorts, liveaboards and dive operators ranked by professional panel, verified votes and expert review.",icon:`<svg viewBox="0 0 64 64" fill="none" stroke="#C9A84C" strokeWidth="1.5" xmlns="http://www.w3.org/2000/svg"><path d="M32 8c-3 0-5.5 2-6.5 4.5C23 11 20 12 18 14.5c-2.5 3-2 7 .5 9.5l-3 2c-1 .5-1.5 1.5-1 2.5l2 4c.5 1 1.5 1.5 2.5 1l3-1.5c2 2 5 3 8 3h4c3 0 6-1 8-3l3 1.5c1 .5 2 0 2.5-1l2-4c.5-1 0-2-1-2.5l-3-2c2.5-2.5 3-6.5.5-9.5-2-2.5-5-3.5-7.5-2C37.5 10 35 8 32 8z" strokeLinecap="round" strokeLinejoin="round"/><path d="M24 44v12M40 44v12M28 44v14M36 44v14" strokeLinecap="round"/><text x="32" y="35" textAnchor="middle" fill="#C9A84C" stroke="none" fontSize="14" fontWeight="700" fontFamily="serif">99</text></svg>`},
  {t:"Top 99 World",c:"#1B6CA8",h:"/top100-world",d:"The global edition. Every continent, every ocean. From the Red Sea to the Caribbean, the Pacific to the Mediterranean. Coming 2026.",icon:`<svg viewBox="0 0 64 64" fill="none" stroke="#C9A84C" strokeWidth="1.5" xmlns="http://www.w3.org/2000/svg"><circle cx="32" cy="32" r="22"/><ellipse cx="32" cy="32" rx="10" ry="22"/><line x1="10" y1="32" x2="54" y2="32"/><line x1="13" y1="22" x2="51" y2="22"/><line x1="13" y1="42" x2="51" y2="42"/><text x="32" y="37" textAnchor="middle" fill="#C9A84C" stroke="none" fontSize="12" fontWeight="700" fontFamily="serif">99</text></svg>`},
  {t:"Best Stays",c:"#0097A7",h:"/stays",d:"99 dive resorts ranked on room quality, service, location and how well the stay supports serious diving.",icon:`<svg viewBox="0 0 64 64" fill="none" stroke="#C9A84C" strokeWidth="1.5" xmlns="http://www.w3.org/2000/svg"><rect x="8" y="28" width="48" height="20" rx="3" strokeLinejoin="round"/><path d="M14 28v-8a4 4 0 014-4h28a4 4 0 014 4v8" strokeLinejoin="round"/><rect x="16" y="20" width="12" height="8" rx="2"/><rect x="36" y="20" width="12" height="8" rx="2"/><line x1="8" y1="48" x2="8" y2="54"/><line x1="56" y1="48" x2="56" y2="54"/><path d="M12 36h40" strokeLinecap="round"/></svg>`},
  {t:"Best Food",c:"#C85A20",h:"/food",d:"99 dive food experiences ranked on freshness, flavour, dietary care and atmosphere. Where divers eat the best.",icon:`<svg viewBox="0 0 64 64" fill="none" stroke="#C9A84C" strokeWidth="1.5" xmlns="http://www.w3.org/2000/svg"><path d="M12 42h40" strokeLinecap="round"/><path d="M14 42c0-14 8-24 18-24s18 10 18 24" strokeLinejoin="round"/><ellipse cx="32" cy="46" rx="22" ry="6"/><circle cx="32" cy="14" r="2.5" fill="#C9A84C" stroke="none"/><line x1="32" y1="16.5" x2="32" y2="18"/></svg>`},
  {t:"Dive Sites",c:"#1B6CA8",h:"/sites",d:"The best walls, wrecks, muck dives, seamounts and shark encounters. Ranked by visibility, marine life, access and wow factor.",icon:`<svg viewBox="0 0 64 64" fill="none" stroke="#C9A84C" strokeWidth="1.5" xmlns="http://www.w3.org/2000/svg"><circle cx="22" cy="26" r="10"/><circle cx="42" cy="26" r="10"/><circle cx="22" cy="26" r="5"/><circle cx="42" cy="26" r="5"/><path d="M32 30v8c0 2-1.5 4-4 5l-6 3" strokeLinecap="round" strokeLinejoin="round"/><path d="M12 22c-2-3-1-8 2-10" strokeLinecap="round"/><path d="M52 22c2-3 1-8-2-10" strokeLinecap="round"/><path d="M32 26v-6" strokeLinecap="round"/></svg>`},
  {t:"Liveaboards",c:"#5E35B1",h:"/liveaboards",d:"49 liveaboards across Indonesia, Maldives, Philippines and Thailand. Comfort, food, crew, safety and dive quality all scored.",icon:`<svg viewBox="0 0 64 64" fill="none" stroke="#C9A84C" strokeWidth="1.5" xmlns="http://www.w3.org/2000/svg"><path d="M6 40l4-4h44l4 4" strokeLinejoin="round"/><path d="M10 36V26a2 2 0 012-2h14v12" strokeLinejoin="round"/><path d="M38 36V20a2 2 0 012-2h8a2 2 0 012 2v16" strokeLinejoin="round"/><path d="M26 36V18l12-6v24" strokeLinejoin="round"/><path d="M6 40c2 4 8 6 14 6h24c6 0 12-2 14-6" strokeLinejoin="round"/><line x1="16" y1="30" x2="22" y2="30"/><rect x="42" y="24" width="4" height="4" rx="0.5"/></svg>`},
  {t:"Sustainable",c:"#2E7D32",h:"/sustainable",d:"Operators leading on reef conservation, waste reduction, community impact and certified sustainability.",icon:`<svg viewBox="0 0 64 64" fill="none" stroke="#C9A84C" strokeWidth="1.5" xmlns="http://www.w3.org/2000/svg"><path d="M32 56V32" strokeLinecap="round"/><path d="M32 32c-6-10-16-14-20-12 2 8 10 16 20 16" strokeLinejoin="round"/><path d="M32 28c4-8 14-12 18-10-1 7-8 14-18 14" strokeLinejoin="round"/><path d="M26 44c-4 2-6 6-6 10" strokeLinecap="round"/><path d="M38 44c4 2 6 6 6 10" strokeLinecap="round"/><circle cx="20" cy="16" r="3"/><circle cx="44" cy="14" r="2"/><circle cx="14" cy="24" r="1.5"/></svg>`},
]
