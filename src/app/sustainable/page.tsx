...
const entries = [
  {rank:1,name:'Misool Eco Resort',loc:'Raja Ampat, Indonesia',type:'Island Resort',cert:'Green Fins',score:'9.8',badge:true,desc:'Operates a 50,000 hectare no-take zone. All solar powered, zero single-use plastic, coral restoration nursery on-site.',pillars:['No-take Zone','Solar','Coral Restoration','Zero Plastic']},
  {rank:2,name:'Barefoot Eco Hotel',loc:'Hanifaru Bay, Maldives',type:'Eco Hotel',cert:'EarthCheck Gold',score:'9.6',badge:true,desc:'Certified carbon-neutral. Works directly with UNESCO biosphere management authority to limit diver impact at Hanifaru.',pillars:['Carbon Neutral','UNESCO Partner','Waste Recycling']},
  {rank:3,name:'Gangga Divers',loc:'North Sulawesi, Indonesia',type:'Dive Operator',cert:'Green Fins',score:'9.5',badge:false,desc:'Green Fins certified operator running reef-check surveys monthly. Mangrove planting programme, no-feed dive policy.',pillars:['Reef Monitoring','Mangrove Planting','Green Fins']},
  {rank:4,name:'Emperor Fleet',loc:'Red Sea & Maldives',type:'Liveaboard Fleet',cert:'Blue Flag',score:'9.4',badge:true,desc:'Fleet-wide prohibition on single-use plastics. Onboard marine biologists, underwater litter collection on every dive.',pillars:['Marine Biologist','Zero Plastic','Litter Dives']},
  {rank:5,name:'Wakatobi Resort',loc:'Wakatobi, Indonesia',type:'Island Resort',cert:'Green Fins',score:'9.3',badge:false,desc:'Coral sponsorship programme (guest-fund corals on the house reef), 100% renewable energy on the main island.',pillars:['Coral Sponsorship','Renewable Energy']},
  {rank:6,name:'Secret Paradise Resort',loc:'Myanmar',type:'Boutique Resort',cert:'Travelife Gold',score:'9.2',badge:false,desc:'Wildlife spotting protocols, local supply chain (90%+ food from local fishermen), plastic-free campus.',pillars:['Local Supply Chain','Plastic-Free','Wildlife Protocols']},
  {rank:7,name:'Tubbataha Conservation Partners',loc:'Palawan, Philippines',type:'Conservation Org',cert:'IUCN Partner',score:'9.1',badge:true,desc:'Manages the UNESCO World Heritage Tubbataha Reef. Operator fee revenues fund ranger patrols and mooring maintenance.',pillars:['UNESCO Heritage','Ranger Support','Mooring Conservation']},
  {rank:8,name:'CoralEye Marine Research',loc:'Bunaken, North Sulawesi',type:'Boutique Resort',cert:'Green Fins',score:'9.0',badge:false,desc:'Partners with Wageningen University on manta and whale shark tracking. Station data openly published for research use.',pillars:['Academic Research','Marine Tracking','Open Data']},
  {rank:9,name:'Aggressor Adventures',loc:'Global Fleet',type:'Liveaboard Fleet',cert:'Green Fins',score:'8.8',badge:false,desc:'The global Aggressor fleet has adopted fleet-wide dive briefings aligned to Green Fins code of conduct.',pillars:['Green Fins Fleet','Dive Codes','Diver Education']},
  {rank:10,name:'Papua Explorers',loc:'Raja Ampat, Indonesia',type:'Dive Lodge',cert:'Green Fins',score:'8.7',badge:true,desc:'100% locally owned and staffed. All profits invested back into the local village and marine patrol programme.',pillars:['Local Ownership','Marine Patrol','Community Investment']},
  {rank:11,name:'Lembeh Resort',loc:'Lembeh Strait, Indonesia',type:'Dive Lodge',cert:'Green Fins',score:'8.6',badge:false,desc:'No gloves policy, buoyancy-first guiding, weekly macro counts shared with IUCN Muck Dive Database.',pillars:['Buoyancy Standards','Citizen Science','Marine Census']},
  {rank:12,name:'Blue Season Bali',loc:'Sanur, Bali',type:'Dive Resort',cert:'PADI Eco',score:'8.4',badge:false,desc:'PADI Eco-certified operator with open-water litter collection, plastic removal certificates for guests.',pillars:['PADI Eco','Litter Collection','Guest Certificates']},
]
