...
const API =
  "https://flhsqerpikhihtirfutu.supabase.co/functions/v1/export-votes?key=BDG2025admin";
...
export default function AdminPage() {
      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: 13, color: "#888", marginBottom: 24 }}>
            Enter your admin PIN to view the vote dashboard
          </p>
          <input
            type="password"
            value={pin}
            ...
            style={{
              ...
              padding: "12px 16px",
              borderRadius: 8,
              border: pinError ? "2px solid #E53935" : "1.5px solid #ddd",
              fontSize: 15,
              textAlign: "center",
              letterSpacing: 4,
              outline: "none",
          ...
          />
          {pinError && (
            <p style={{ fontSize: 12, color: "#E53935", margin: "0 0 12px" }}>
              Wrong PIN. Try again.
            </p>
          )}
          <button
  ...
  const topPlaces = votes.reduce(
    (acc, v) => {
      const pn = v.place_name || v.best_dive_resort;
  ...
  return (
    ...
    >
      <Nav />
      <div
        style={{ background: "#0A2342", padding: "2rem clamp(1rem,3vw,2rem)" }}
      >
        <div
          style={{
            maxWidth: 1200,
      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{ fontSize: 28, fontWeight: 700, color: "#0A2342" }}>
              {totalVotes}
            </div>
          </div>
          <div
          ...
          >
            ...
            <div style={{ fontSize: 28, fontWeight: 700, color: "#0A2342" }}>
              {votes.filter((v) => v.is_panel_member).length}
            </div>
          </div>
        </div>
        <div
        ...
        >
          {[
            { title: "Top Places Voted", data: sortedPicks(topPlaces) },
                ...
                sec.data.map(([name, count], i) => (
                  <div
                    ...
                    style={{
                      ...
                      padding: "4px 0",
                      borderBottom:
                        i < sec.data.length - 1 ? "1px solid #f0f0f0" : "none",
                    }}
                  >
                    <span
                      style={{
              ...
              <tbody>
                {filtered.map((v) => (
                  <tr key={v.id} style={{ borderBottom: "1px solid #f0f0f0" }}>
                    ...
                    >
                      {v.place_name || v.best_dive_resort || "-"}
                    </td>
                    <td style={{ padding: "10px 14px", fontSize: 11 }}>
                      ...
                      {!v.dive_rating && !v.food_rating && !v.stay_rating
                        ? "-"
                        : null}
                    </td>
                    <td style={{ padding: "10px 14px" }}>
          ...
          >
            ...
            >
              {[
                [
                  "Place Voted",
                  selected.place_name || selected.best_dive_resort,
                ],
                ["Email", selected.email],
                ["Country", selected.country],
                ["Role", selected.voter_role],
                [
                  "Cert",
                  (selected.cert_agency || "") +
                    " " +
                    (selected.cert_level || ""),
                ],
                ["Dives", selected.logged_dives],
            ...
            >
              ...
              <div style={{ display: "flex", gap: 16 }}>
                {[
                  ["Dive", selected.dive_rating],
                  ["Food", selected.food_rating],
                  ["Stay", selected.stay_rating],
                ].map(([l, v]) => (
