...
const ALL: LB[] = [
  {
    ...
    area: "Raja Ampat, Komodo, Banda Sea",
    country: "Indonesia",
    winner: true,
  ...
  },
  {
    rank: 2,
    name: "Scubaspa Yang",
    area: "Central & Southern Atolls",
    country: "Maldives",
    url: "https://www.scubaspa.com/yang/",
    desc: "One of the highest-rated Maldives luxury liveaboards. Spa and dive hybrid concept.",
  },
  {
    rank: 3,
    name: "Scubaspa Zen Indonesia",
    area: "Komodo, Raja Ampat, Banda Sea",
    country: "Indonesia",
    url: "https://www.scubaspa.com/zen/",
  ...
  },
  {
    ...
    area: "Tubbataha, Visayas",
    country: "Philippines",
    url: "https://www.sirenfleet.com/philippine-siren/",
  ...
  },
  {
    ...
    country: "Indonesia",
    url: "https://mikumbadiving.com/",
    desc: "Excellent review scores, strong value, intimate Indonesian liveaboard feeling.",
  },
  {
    rank: 6,
    name: "Sawasdee Fasai",
    area: "Similan Islands, Richelieu Rock",
    country: "Thailand",
    url: "https://www.sawasdeefasai.com/",
  ...
  },
  {
    ...
    area: "Central Atolls",
    country: "Maldives",
    url: "https://www.spiritofmaldivesliveaboard.com/",
  ...
  },
  {
    ...
    area: "Raja Ampat, Komodo",
    country: "Indonesia",
    url: "https://www.samambaia-liveaboard.com/",
  ...
  },
  {
    ...
    area: "Tubbataha, Visayas",
    country: "Philippines",
    url: "https://www.solitudeliveaboards.com/",
  ...
  },
  {
    ...
    area: "Raja Ampat, Komodo, Banda Sea",
    country: "Indonesia",
    url: "https://www.bluemantadiving.com/",
  ...
  },
  {
    ...
    area: "Raja Ampat, Komodo",
    country: "Indonesia",
    url: "https://www.damailiveaboard.com/",
  ...
  },
  {
    ...
    area: "Raja Ampat, Komodo",
    country: "Indonesia",
    url: "https://www.jelajahilaut.com/",
  ...
  },
  {
    ...
    area: "Similans, Surin, Richelieu Rock",
    country: "Thailand",
    url: "https://www.master-liveaboards.com/thailand-master/",
    desc: "Strong brand, good for Similans, Surin, Richelieu and sometimes Myanmar routes.",
  },
  {
    rank: 18,
    name: "Ambai",
    area: "Raja Ampat, Banda Sea",
    country: "Indonesia",
    url: "https://www.ambai-liveaboard.com/",
  ...
  },
  {
    ...
    area: "Raja Ampat, Komodo, Banda Sea",
    country: "Indonesia",
    url: "https://www.dewinusantara.com/",
  ...
  },
  {
    rank: 23,
    name: "Pindito",
    area: "Raja Ampat, Banda Sea, Alor",
    country: "Indonesia",
    url: "https://www.pindito.com/",
  ...
  },
  {
    ...
    area: "Raja Ampat, Komodo",
    country: "Indonesia",
    url: "https://www.lagaligoliveaboard.com/",
  ...
  },
  {
    ...
    area: "Central Atolls",
    country: "Maldives",
    url: "https://www.emperordivers.com/liveaboards/emperor-virgo/",
  ...
  },
  {
    ...
    country: "Thailand",
    url: "https://www.seatopialiveaboard.com/",
  ...
  },
  {
    ...
    area: "Raja Ampat",
    country: "Indonesia",
    url: "https://www.coralia-liveaboard.com/",
  ...
  },
  {
    ...
    area: "Raja Ampat, Komodo",
    country: "Indonesia",
    url: "https://www.gaialoveadventures.com/",
  ...
  },
  {
    ...
    area: "Central Atolls",
    country: "Maldives",
    url: "https://www.emperordivers.com/liveaboards/emperor-serenity/",
  ...
  },
  {
    ...
    area: "Central Atolls",
    country: "Maldives",
    url: "https://www.carpediemmaldives.com/carpe-novo/",
  ...
  },
  {
    ...
    area: "Tubbataha, Visayas",
    country: "Philippines",
    url: "https://www.atlantishotel.com/",
  ...
  },
  {
    ...
    area: "Raja Ampat, Komodo",
    country: "Indonesia",
    url: "https://www.aliikai.com/",
    desc: "Boutique luxury option with strong comfort and service.",
  },
  {
    rank: 39,
    name: "Emperor Explorer",
    area: "Central & Northern Atolls",
    country: "Maldives",
    url: "https://www.emperordivers.com/liveaboards/emperor-explorer/",
  ...
  },
  {
    ...
    area: "Raja Ampat",
    country: "Indonesia",
    url: "https://www.jayaliveaboard.com/",
  ...
  {
    rank: 42,
    name: "Emperor Raja Laut",
    area: "Raja Ampat, Komodo",
    country: "Indonesia",
    url: "https://www.emperordivers.com/liveaboards/emperor-raja-laut/",
    desc: "Strong guest comments for crew, food, and relaxed operation.",
  },
  {
    rank: 43,
    name: "Stella Maris Explorer",
    area: "Tubbataha, Apo Reef",
    country: "Philippines",
    url: "https://www.stellamarisexplorer.com/",
  ...
  },
  {
    ...
    area: "Central Atolls",
    country: "Maldives",
    url: "https://www.ecoprodivers.com/",
    desc: "Good review signal and value in Maldives.",
  },
  {
    rank: 45,
    name: "Amba Liveaboard",
    area: "Northern Atolls",
    country: "Maldives",
    url: "https://www.ambaliveaboard.com/",
  ...
  },
  {
    ...
    area: "Raja Ampat",
    country: "Indonesia",
    url: "https://www.epicaliveaboard.com/",
  ...
  },
  {
    ...
    area: "Central Atolls",
    country: "Maldives",
    url: "https://www.ecoblueliveaboard.com/",
  ...
  },
  {
    ...
    area: "Central Atolls",
    country: "Maldives",
    url: "https://www.princesssaramaldives.com/",
...
export default function Liveaboards() {
  ...
  const filtered =
    filterCountry === "all"
      ? ALL
      : ALL.filter((e) => e.country === filterCountry);
  return (
    <div
      style={{
    ...
    >
      ...
      >
        ...
        >
          {" "}
          The 49 Best <span style={{ color: "#E8723A" }}>Liveaboards</span> in
          Asia{" "}
        </h1>{" "}
        <p
          style={{
        ...
        >
          {" "}
          Ranked on dive quality, comfort, food, safety, crew, and overall guest
          experience across Indonesia, Maldives, Philippines, and Thailand.{" "}
        </p>{" "}
        <div
          style={{
            display: "flex",
        ...
        >
          ...
          {[
            ...
            >
              {" "}
              <div
                style={{ color: s.color, fontWeight: 700, fontSize: "22px" }}
              >
                {s.n}
              </div>
              <div
      ...
      >
        ...
        >
          {" "}
          Best all-round liveaboard for serious divers who still want
          comfort.{" "}
        </span>{" "}
      </div>{" "}
      {/* Country filter */}{" "}
      ...
      >
        ...
        {["all", "Indonesia", "Maldives", "Philippines", "Thailand"].map(
          (c) => (
            <button
              key={c}
      ...
      >
            ...
            return (
              <div
                ...
                style={{
                  ...
                  gap: "1.25rem",
                  boxShadow: e.winner
                    ? "0 4px 20px rgba(232,114,58,0.12)"
        ...
        >
          ...
          >
            {" "}
            Rankings based on public review signals from Liveaboard.com, PADI
            Travel, ZuBlu, Bluewater Dive Travel, DiveIN, and operator
            reputation.{" "}
          </p>{" "}
        </div>{" "}
      </div>
