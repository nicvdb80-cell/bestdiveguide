...
const entries: LBEntry[] = [
  ...
  { rank:2, name:"Scubaspa Zen Indonesia", area:"Komodo, Raja Ampat, Banda Sea", country:"Indonesia",
    desc:"Luxury comfort with strong itineraries across three of Indonesia\u2019s best dive regions. High-end guest experience." },
  { rank:3, name:"Mikumba Dua", area:"Raja Ampat, Komodo", country:"Indonesia",
    desc:"Excellent review scores, strong value, intimate Indonesian liveaboard feeling." },
  { rank:4, name:"Amaya Explorer", area:"Raja Ampat, Komodo", country:"Indonesia",
    desc:"Very high public review score, good balance of comfort, route quality, and price." },
  { rank:5, name:"Samambaia", area:"Raja Ampat, Komodo", country:"Indonesia",
    desc:"Premium phinisi, strong reputation, excellent for serious divers and photographers." },
  { rank:6, name:"Blue Manta", area:"Raja Ampat, Komodo, Banda Sea", country:"Indonesia",
    desc:"Large, professional, very reliable for Raja Ampat, Komodo and Banda routes." },
  { rank:7, name:"Jelajahi Laut", area:"Raja Ampat, Komodo", country:"Indonesia",
    desc:"High review score, good price-to-value ratio, strong guest feedback." },
  { rank:8, name:"White Manta", area:"Raja Ampat, Komodo", country:"Indonesia",
    desc:"Comfortable, professional, good for photographers and experienced divers." },
  { rank:9, name:"Scubaspa Yang", area:"Central & Southern Atolls", country:"Maldives",
    desc:"One of the highest-rated Maldives luxury liveaboards. Spa and dive hybrid concept." },
  { rank:10, name:"Spirit of Maldives", area:"Central Atolls", country:"Maldives",
    desc:"Strong verified reviews, especially for food, comfort and crew quality." },
  { rank:11, name:"Mermaid I", area:"Raja Ampat, Komodo", country:"Indonesia",
    desc:"Long-established premium Indonesia liveaboard with strong safety and service reputation." },
  { rank:12, name:"Mermaid II", area:"Raja Ampat, Komodo", country:"Indonesia",
    desc:"Reliable, professional, popular for Komodo and Raja Ampat routes." },
  { rank:13, name:"Ambai", area:"Raja Ampat, Banda Sea", country:"Indonesia",
    desc:"Serious diver boat with a strong Raja Ampat and Banda Sea reputation." },
  { rank:14, name:"Tiare Cruise", area:"Raja Ampat, Komodo", country:"Indonesia",
    desc:"Premium comfort, boutique service, strong Indonesia itineraries." },
  { rank:15, name:"La Galigo", area:"Raja Ampat, Komodo", country:"Indonesia",
    desc:"Popular, well-reviewed, strong Raja Ampat and Komodo value proposition." },
  { rank:16, name:"Pindito", area:"Raja Ampat, Banda Sea, Alor", country:"Indonesia",
    desc:"Legendary Indonesia pioneer with a strong historical reputation among serious divers." },
  { rank:17, name:"Damai I", area:"Raja Ampat, Komodo", country:"Indonesia",
    desc:"High-end service, boutique luxury, excellent food and comfort reputation." },
  { rank:18, name:"Damai II", area:"Raja Ampat, Komodo", country:"Indonesia",
    desc:"Bigger sister to Damai I with premium service and dive experience." },
  { rank:19, name:"Coralia", area:"Raja Ampat", country:"Indonesia",
    desc:"Luxury phinisi, good for Raja Ampat with strong comfort and design." },
  { rank:20, name:"Gaia Love", area:"Raja Ampat, Komodo", country:"Indonesia",
    desc:"Premium, spacious, photographer-friendly, strong dive deck setup." },
  { rank:21, name:"Seven Seas", area:"Raja Ampat, Komodo, Banda Sea", country:"Indonesia",
    desc:"Classic high-end Indonesia liveaboard with loyal repeat guests." },
  { rank:22, name:"Dewi Nusantara", area:"Raja Ampat, Komodo, Banda Sea", country:"Indonesia",
    desc:"One of the grand luxury Indonesia vessels. Spacious and iconic." },
  { rank:23, name:"Lady Denok", area:"Raja Ampat, Komodo", country:"Indonesia",
    desc:"Consistently strong public review score and value." },
  { rank:24, name:"Jaya", area:"Raja Ampat", country:"Indonesia",
    desc:"High review volume, good value, good Raja Ampat presence." },
  { rank:25, name:"Raja Ampat Aggressor", area:"Raja Ampat", country:"Indonesia",
    desc:"International brand, reliable Raja Ampat operation." },
  { rank:26, name:"Emperor Raja Laut", area:"Raja Ampat, Komodo", country:"Indonesia",
    desc:"Strong guest comments for crew, food, and relaxed operation." },
  { rank:27, name:"Aliikai", area:"Raja Ampat, Komodo", country:"Indonesia",
    desc:"Boutique luxury option with strong comfort and service." },
  { rank:28, name:"Epica", area:"Raja Ampat", country:"Indonesia",
    desc:"More affordable Raja Ampat option with strong guest praise." },
  { rank:29, name:"Akomo Isseki", area:"Raja Ampat", country:"Indonesia",
    desc:"Good value, intimate, suited to divers wanting smaller boats." },
  { rank:30, name:"Carpe Diem Maldives", area:"Central Atolls", country:"Maldives",
    desc:"Established Maldives brand, good central atoll trips." },
  { rank:31, name:"Carpe Novo", area:"Central Atolls", country:"Maldives",
    desc:"Modern, comfortable Maldives operation." },
  { rank:32, name:"Carpe Vita", area:"Central & Southern Atolls", country:"Maldives",
    desc:"Premium Maldives liveaboard with a strong service reputation." },
  { rank:33, name:"Emperor Virgo", area:"Central Atolls", country:"Maldives",
    desc:"Reliable Emperor Maldives boat, good manta and shark routes." },
  { rank:34, name:"Emperor Serenity", area:"Central Atolls", country:"Maldives",
    desc:"Larger comfort-focused Maldives liveaboard." },
  { rank:35, name:"Emperor Explorer", area:"Central & Northern Atolls", country:"Maldives",
    desc:"Established Maldives boat with reliable logistics and itineraries." },
  { rank:36, name:"EcoPro Seascape", area:"Central Atolls", country:"Maldives",
    desc:"Good review signal and value in Maldives." },
  { rank:37, name:"Amba Liveaboard", area:"Northern Atolls", country:"Maldives",
    desc:"Strong for northern Maldives and more remote routes." },
  { rank:38, name:"Eco Blue", area:"Central Atolls", country:"Maldives",
    desc:"Good food and value signals in public reviews." },
  { rank:39, name:"Princess Sara", area:"Central Atolls", country:"Maldives",
    desc:"Strong review count and value-driven Maldives option." },
  { rank:40, name:"Arora Virgo", area:"Central Atolls", country:"Maldives",
    desc:"Very high score but smaller review sample. Promising luxury and value option." },
  { rank:41, name:"Philippine Siren", area:"Tubbataha, Visayas", country:"Philippines",
    desc:"Strong reputation, good Tubbataha and Visayas itineraries, excellent crew comments." },
  { rank:42, name:"Solitude One", area:"Tubbataha, Visayas", country:"Philippines",
    desc:"Premium Philippines and Tubbataha option with strong food and operation feedback." },
  { rank:43, name:"Infiniti", area:"Tubbataha, Visayas", country:"Philippines",
    desc:"Good Tubbataha and Visayas option with strong food and diving comments." },
  { rank:44, name:"Philippines Aggressor II", area:"Tubbataha, Visayas", country:"Philippines",
    desc:"International standard, good for Tubbataha and Visayas." },
  { rank:45, name:"Atlantis Azores", area:"Tubbataha, Visayas", country:"Philippines",
    desc:"Established Philippines operator with good food and crew comments." },
  { rank:46, name:"Stella Maris Explorer", area:"Tubbataha, Apo Reef", country:"Philippines",
    desc:"Solid Tubbataha and Apo Reef option, comfortable mid-to-upper range." },
  { rank:47, name:"Sawasdee Fasai", area:"Similan Islands, Richelieu Rock", country:"Thailand",
    desc:"Very high review volume and strong Similan and Richelieu Rock value." },
  { rank:48, name:"Thailand Master", area:"Similans, Surin, Richelieu Rock", country:"Thailand",
    desc:"Strong brand, good for Similans, Surin, Richelieu and sometimes Myanmar routes." },
  { rank:49, name:"Seatopia", area:"Similan Islands", country:"Thailand",
    desc:"Excellent review score, strong budget and value position." },
  { rank:50, name:"The Junk", area:"Similan Islands, Richelieu Rock", country:"Thailand",
