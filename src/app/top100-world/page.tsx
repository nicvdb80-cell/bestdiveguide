      ...
      >
        ...
        <div
          style={{
            ...
            border: "1px solid rgba(232,114,58,0.4)",
            color: "#E8723A",
            fontSize: "11px",
            fontWeight: 700,
            letterSpacing: "2px",
        ...
        >
          {" "}
          The global ranking is currently in progress. We are expanding beyond
          Asia to rank the best dive experiences worldwide.{" "}
        </p>{" "}
        <div
          style={{
            display: "inline-block",
