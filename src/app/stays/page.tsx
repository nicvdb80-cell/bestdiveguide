  ...
  return (
    <div style={{fontFamily:"Inter,system-ui,sans-serif",minHeight:"100vh",background:"#F8F9FA"}}>
      ...
      <div style={{background:"linear-gradient(135deg,#0A2342 0%,#1B3A5C 100%)",padding:"clamp(2rem,5vw,4rem) clamp(1rem,3vw,2rem) clamp(1.5rem,4vw,3rem)",textAlign:"center"}}>
        ...
        <h1 style={{color:"#fff",fontSize:"clamp(26px,5.5vw,42px)",fontWeight:700,lineHeight:1.15,maxWidth:700,margin:"0 auto 1rem"}}>The 99 Best <span style={{color:"#0097A7"}}>Stay, Dine and Dive</span> Experiences in Asia</h1>
      ...
      <div style={{background:"#0097A7",padding:"12px clamp(1rem,3vw,2rem)",textAlign:"center"}}>
        <span style={{color:"#fff",fontSize:14,fontWeight:700}}>Best Stay, Dine and Dive Experience - Coral Eye, Bangka Island</span>
      </div>
