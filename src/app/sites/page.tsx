...
const entries: SiteType[] = [
  ...
  {
    rank: 8,
    name: "Banda Sea - Banda Neira",
    loc: "Maluku, Indonesia",
    region: "Coral Triangle",
    type: "Volcanic Wall",
    depth: "5-50m+",
    score: "9.2",
  ...
  {
    rank: 12,
    name: "Shark and Yolanda Reefs",
    loc: "Ras Mohammed, Egypt",
    region: "Red Sea",
    type: "Reef & Wreck",
    depth: "5-30m",
    score: "8.8",
...
export default function Sites() {
  return (
    ...
    >
      ...
      <div
        style={{
          background: "linear-gradient(135deg,#002233 0%,#003D57 100%)",
          padding:
      ...
      >
        ...
        >
          Top 99 <span style={{ color: "#0097A7" }}>Dive Sites</span> in the
          World
        </h1>
        <p
          style={{
        ...
        >
          Walls, wrecks, muck, seamounts, and passes - ranked by experienced
          divers on marine life density, visibility, and accessibility.
        </p>
      </div>
